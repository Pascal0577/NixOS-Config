...
in
{
    options.mySystem.applications.neovim = {
        enable = lib.mkEnableOption "Neovim editor module";
        enableLatex = lib.mkEnableOption "Nixvim config" // { default = true; };
